...
export default function ReservationSum(props) {
  ...
  return (
    <div className={classes.root}>
      ...
      >
        ...
        <Divider />
        {/* userlevel에 따른 메뉴 생성 187 ~ 243번째 줄 수정- phs */}
            <List>
                {
                        ...
                        axios({
                            ...
                            .then(function(res) {
                                if(res.statusText == "OK") {
                                  ...
                                  alert('ReservationSum.js 253 line error');
                                }
                            })
                            .catch(function(error) {
                                console.log(error);
      ...
      <div >
        <Paper className={clsx(classes.rootPaper,{
              [classes.rootPaper2]: open,
        })}>
            <ManageTable st = {props.history.location.state.reservationsum}
            y = {props.match.params.year}
             m = {props.match.params.month}
             page='sum'/>
        </Paper>
      </div>
